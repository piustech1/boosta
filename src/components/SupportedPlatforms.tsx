  ...
  const platforms = [
    {
      ...
      quote: "Unlock the TikTok viral algorithm! Instant high-retention views & likes ready! ⚡",
      icon: (
    ...
    },
    {
      ...
      quote: "Turbocharge your Instagram Reels, followers & engagement in seconds! 📸",
      icon: (
    ...
    },
    {
      ...
      quote: "Scale your Telegram channels! Real active members & post views deployed! ✈️",
      icon: (
        <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
